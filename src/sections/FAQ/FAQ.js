            ...
            <div className="faq-text">
                ...
                <div className="faq-details">
                    <div className={"faq-col"}>
                        ...
                        <p>We'll have a Slack workplace and use Zoom/Youtube Live to host and stream workshops and other activities.</p>
                    ...
                    <div className={"faq-col"}>
                        ...
                        <p>Yes! We’ll have a few intro to design tools workshops that will help you get up to speed.</p>
                        <h2>What do I do if I don't have a team?</h2>
                        <p>Don't worry! We’ll have a Slack channel where you can meet other participants and form teams.</p>
